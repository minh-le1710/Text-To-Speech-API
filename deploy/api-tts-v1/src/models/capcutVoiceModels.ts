...
export const fallbackVoicePresets: VoicePreset[] = [
  ...
  },
  {
    ...
    effectId: '7483736254694035984',
    resourceId: '7483736254694035984',
  },
  {
    title: 'Giọng nữ phổ thông',
    description: 'Giọng nữ tiếng Việt phổ thông',
    speaker: 'vi_female_huong',
    effectId: '7264854897953083905',
    resourceId: '7264854897953083905',
  },
  {
    title: 'Nguồn nhỏ ngọt ngào',
    description: 'Giọng nữ tiếng Việt ngọt ngào',
    speaker: 'BV421_vivn_streaming',
    effectId: '7252594014782755330',
    resourceId: '7252594014782755330',
  },
  {
    title: 'Tin',
    description: 'Giọng nam tiếng Việt tự tin',
    speaker: 'BV075_streaming',
    effectId: '7102355803792740865',
    resourceId: '7102355803792740865',
  },
  {
    title: 'Ngôn',
    description: 'Giọng tiếng Việt dễ thương',
    speaker: 'BV074_streaming',
    effectId: '7102355709945188865',
...
export const voiceAliases: Record<string, string> = {
  ...
  chi_mai: '7483736254694035984',
  'chi-mai': '7483736254694035984',
  'chi mai': '7483736254694035984',
  giong_nu_pho_thong: '7264854897953083905',
  'giong-nu-pho-thong': '7264854897953083905',
  'giong nu pho thong': '7264854897953083905',
  'giọng nữ phổ thông': '7264854897953083905',
  nguon_nho_ngot_ngao: '7252594014782755330',
  'nguon-nho-ngot-ngao': '7252594014782755330',
  'nguon nho ngot ngao': '7252594014782755330',
  'nguồn nhỏ ngọt ngào': '7252594014782755330',
  tin: '7102355803792740865',
  ngon: '7102355709945188865',
  ngôn: '7102355709945188865',
};
